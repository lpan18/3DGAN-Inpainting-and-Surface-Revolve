...
class Discriminator( nn.Module ):
    ...
    def __init__( self, d=128 ):
        ...
        self.offset3 = ConvOffset2D(d * 2)
        self.conv3 = nn.Conv2d( d * 2, d * 4, 4, 2, 1)
        self.conv3_bn = nn.BatchNorm2d( d * 4 )
        
        self.offset4 = ConvOffset2D(d * 4)
    ...
    def forward( self, input ):
        ...
        x = F.leaky_relu( self.conv3_bn( self.conv3( self.offset3( x ) ) ), 0.2 )
        x = F.leaky_relu( self.conv4_bn( self.conv4( self.offset4( x ) ) ), 0.2 )
